 ...
 */
vector_t* vector_create(int limit, int step);
 ...
 */
void vector_destroy_items(vector_t* vector);
 ...
 *
 */
vector_t* vector_copy_if(vector_t* original, int (*filter)(void* item));
 ...
 */
int vector_append(vector_t* vector, void* item);
 ...
 */
int vector_append_vector(vector_t* dst, vector_t* src);
 ...
 */
int vector_insert(vector_t* vector, void* item, int pos);
 ...
 * item is removed.
 */
void vector_set_destroyer(vector_t* vector, void (*destroyer) (void* item));
 ...
 *
 */
void vector_set_sorter(vector_t* vector, void (*sorter) (vector_t* vector, void* item));
 ...
 */
void vector_generic_destroyer(void* item);
 ...
 *
 */
void* vector_item(vector_t* vector, int index);
 ...
 */
void vector_set_item(vector_t* vector, int index, void* item);
 ...
 */
int vector_index(vector_t* vector, void* item);
 ...
 */
vector_iter_t vector_iterator(vector_t* vector);

/**
 * @brief Return the vector of this iterator
 */
vector_t* vector_iterator_vector(vector_iter_t* it);

/**
 * @brief Return the number of items of iterator
 */
int vector_iterator_count(vector_iter_t* it);
 ...
 */
void* vector_iterator_prev(vector_iter_t* it);
 ...
 */
void vector_iterator_set_filter(vector_iter_t* it, int (*filter) (void* item));

/**
 * @brief Set current iterator position
 */
void vector_iterator_set_current(vector_iter_t* it, int current);

/**
 * @brief Set iterator position to the last element
 */
void vector_iterator_set_last(vector_iter_t* it);

/**
 * @brief Return current iterator position
 */
int vector_iterator_current(vector_iter_t* it);

/**
 * @brief Reset iterator position to initial
 */
void vector_iterator_reset(vector_iter_t* it);
