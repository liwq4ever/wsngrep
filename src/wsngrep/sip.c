...
void sip_init(int limit, int only_calls, int no_incomplete)
{
...
char* sip_get_callid(const char* payload, char* callid)
{
    regmatch_t pmatch[3];
...
char* sip_get_xcallid(const char* payload, char* xcallid)
{
    regmatch_t pmatch[3];
...
#define ADD_STREAM(stream) \
    ...
    char media_type[MEDIATYPELEN + 1] = { 0 };
    char media_format[30] = { 0 };
    char address[ADDRESSLEN + 1] = { 0 };
